          ...
          <div className='text-center'>
            ...
            >
              <Button
                asChild
                size='lg'
                className='shadow-lg hover:shadow-xl transition-shadow duration-300 z-100'
              >
          ...
          <section className='mb-16'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
              {[
                {
                  title: 'Quality',
                  description: 'Premium wood from sustainable sources',
                  icon: <Award className='w-8 h-8' />,
                },
                {
                  title: 'Variety',
                  description: 'Wide range of wood types for every need',
                  icon: <ChevronDown className='w-8 h-8' />,
                },
                {
                  title: 'Expertise',
                  description: 'Expert advice and customer support',
              ...
              {[
                {
                  ...
                  description: 'We offer custom cutting services to meet your specific needs.',
                  icon: <ChevronDown className='w-8 h-8' />,
                },
                {
                  title: 'Fast Delivery',
                ...
                },
                {
                  ...
                  description: 'Get advice from our wood experts for your projects.',
                  icon: <Shield className='w-8 h-8' />,
                },
              ].map((service, index) => (
                <Card key={index} className='hover:shadow-lg transition-shadow duration-300'>
