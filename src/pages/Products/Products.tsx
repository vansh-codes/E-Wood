...
export default function Products() {
  ...
  const applyFilters = () => {
    ...
    if (pendingFilters.maxPrice !== 15000)
      params.set('maxPrice', pendingFilters.maxPrice.toString())
  ...
  return (
    ...
    >
      ...
      <div className='container mx-auto px-4 py-8'>
                ...
                <div className='py-4 space-y-4'>
                  ...
                  <div>
                    ...
                    <RadioGroup
                      ...
                      onValueChange={(value) =>
                        setPendingFilters((prev) => ({ ...prev, rating: value }))
                      }
                    >
        ...
        {!loading &&
          visibleProducts >= productsData.products.length &&
          filteredProducts.length !== 0 && (
