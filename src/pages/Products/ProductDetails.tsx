      ...
      <div className='min-h-screen p-8'>
        ...
        <div className='rounded-lg shadow-lg overflow-hidden'>
          <div className='md:flex'>
            ...
            <div className='md:w-1/2 p-8'>
              ...
              <div className='mt-4'>
                ...
                <span
                  className={`text-3xl font-bold text-gray-900 dark:text-white ${product.stock <= 0 ? 'line-through' : ''}`}
                >
              ...
              <div className='mt-6 flex items-center'>
                ...
                <span className='mx-4 text-xl text-gray-900 dark:text-white'>
                  {product.quantity}
                </span>
                <Button
                  variant='outline'
          ...
          <Tabs defaultValue='specifications' className='p-8'>
            <TabsList>
              {' '}
              {/* style the tabs trigger later with theme */}
