            ...
            <Accordion type='single' collapsible className='w-full'>
              ...
              <AccordionItem value='item-2'>
                ...
                <AccordionContent>
                  ...
                  <p>
                    We may also use your information for other purposes with your consent or as
              ...
              <AccordionItem value='item-3'>
                ...
                <AccordionContent>
                  ...
                  <ul className='list-disc pl-6 mb-2'>
                    <li>
                      Service providers who assist us in operating our platform and conducting our
                      business
                    </li>
                    <li>Law enforcement or government agencies in response to a legal request</li>
                    <li>
                      Other parties in connection with a company transaction, such as a merger or
                      sale of assets
                    </li>
                  </ul>
                  <p>
